...
from barbican.api.controllers import sgx
...
class V2Controller(V1Controller):
    """Root controller for the v2 API"""

    version_string = 'v2'

    version_id = 'v2'

    last_updated = '2016-06-20T00:00:00Z'

    def __init__(self):
        LOG.debug('=== Creating V2Controller ===')
...
AVAILABLE_VERSIONS = {
    ...
    V2Controller.version_string: V2Controller,
}
